...
- **The "All" channel tab was not sorted by channel number** — it simply
  concatenated the tag groups, so a channel whose tag differed from its
  neighbours ended up out of place.
